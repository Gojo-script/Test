...
function YEDHODHEEYAYYAYASDO_ASDFMNCASDJI_ZXJI()
    if _G.KaitunMode then
        loadstring(game:HttpGet(("https://raw.githubusercontent.com/WxHxCxKxExR/Normal_Mb/main/BF-KT-MB.lua"), true))();
    elseif _G.Script_Language == "Thai" then
        loadstring(game:HttpGet(("https://raw.githubusercontent.com/WxHxCxKxExR/Normal_Mb/main/BF-TH-MB.lua"), true))();
    else
...
if not _G.Setting then
    _G.Setting = {
		...
		AutoPoleVer1 = false,
		AutoPoleVer1HOP = false,
		AutoSaber = false,
		AutoSaber_Hop = false,
		AutoTwinHooks = false,
		AutoTwinHooksHop = false,
		AutoSerpentBow = false,
		AutoSerpentBowHop = false,
		AutoFarmLevel = false,
		AutoNewWorld = false,
		...
		FindFullMoon = false,
		AutoCompleteTrail = false,
		AutoGetCDK = false,
		AutoQuestTushuta = false,
		AutoQuestYama = false,
		AutoFarmMasteryFruit = false,
		AutoFarmMasteryGun = false,
		AutoFinishDoughDungeons = false,
		AutoFinishPhoenixDungeons = false,
		...
		AutoBuyEnchamentHaki = false,
		AutoBuyEnchamentHakiHop = false,
		AutoMysticIsland = false,
		HopFindIsland = false,
		AutoEliteHunter = false,
		AutoEliteHunterHop = false,
		StopAtGodChalice = false,
		AutoSpawnBossCakePiece = false,
		AutoCakePiece = false,
		AutoSpinBone = false,
		AutoFarmBone = false,
		AutoBuyItem = false,
...
LoadSave()
    ...
    Item:AddToggle("Auto Hallow Scythe",_G.Setting.AutoFarmBossHallow,function(value)
        SaveSetting()
    ...
    Item:AddToggle("Auto Hallow Scythe [ Hop ]",_G.Setting.AutoFarmBossHallowHOP,function(value)
        SaveSetting()
    ...
    Item:AddToggle("Auto Buddy Sword",_G.Setting.AutoBuddySword,function(value)
        SaveSetting()
    ...
    Item:AddToggle("Auto Buddy Sword [ Hop ]",_G.Setting.AutoBuddySwordHOP,function(value)
        SaveSetting()
    ...
    Item:AddToggle("Auto Canvander",_G.Setting.AutoCanvander,function(value)
        SaveSetting()
    ...
    Item:AddToggle("Auto Canvander [ Hop ]",_G.Setting.AutoCanvanderHOP,function(value)
        SaveSetting()
    ...
    Item:AddToggle("Auto Dark Dagger",_G.Setting.AutoDarkDagger,function(value)
        SaveSetting()
    ...
    Item:AddToggle("Auto Dark Dagger [ Hop ]",_G.Setting.AutoDarkDaggerHOP,function(value)
        SaveSetting()
    ...
    Item:AddToggle("Auto Pole v1",_G.Setting.AutoPoleVer1,function(value)
        SaveSetting()
    ...
    Item:AddToggle("Auto Pole v1 [ Hop ]",_G.Setting.AutoPoleVer1HOP,function(value)
        SaveSetting()
    ...
    Item:AddToggle("Auto Saber",_G.Setting.AutoSaber,function(value)
        SaveSetting()
        _G.AutoSaber = value
        SaveSetting()
        Clip = value
    ...
    Item:AddToggle("Auto Saber [ Hop ]",_G.Setting.AutoSaber_Hop,function(value)
        SaveSetting()
    ...
    Item:AddToggle("Auto Twin Hooks",_G.Setting.AutoTwinHooks,function(value)
        SaveSetting()
    ...
    Item:AddToggle("Auto Twin Hooks [ Hop ]",_G.Setting.AutoTwinHooksHop,function(value)
        SaveSetting()
    ...
    Item:AddToggle("Auto Serpent bow",_G.Setting.AutoSerpentBow,function(value)
        SaveSetting()
    ...
    Item:AddToggle("Auto Serpent bow [ Hop ]",_G.Setting.AutoSerpentBowHop,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Farm Level",_G.Setting.AutoFarmLevel,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto New World",_G.Setting.AutoNewWorld,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Thrid World",_G.Setting.AutoThirdWorld,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Rejoin",_G.Setting.AutoRejoin,function(value)
        SaveSetting()
        _G.AutoRejoin = value
        SaveSetting()
    end)

    Main:AddToggle("Fast Attack",_G.Setting.FastAttackT,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Screen Boost",_G.Setting.ScreenBoost,function(value)
        SaveSetting()
        SaveSetting()
        if value then
    ...
    Main:AddToggle("Auto Soul Guitar [ 20(s) ]",_G.Setting.AutoSoulGuitar,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Hop Find Full Moon [ Server ]",_G.Setting.FindFullMoon,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Complete Race V.4",_G.Setting.AutoCompleteTrail,function(value)
        SaveSetting()
        SaveSetting()
    ...
    Main:AddToggle("Auto Get [ Cursed Dual Katana ]",_G.Setting.AutoGetCDK,function(value)
        SaveSetting()
        _G.AutoGetCDK = value
        SaveSetting()
        Clip = value
    ...
    Main:AddToggle("Auto Quest [ Tushuta ]",_G.Setting.AutoQuestTushuta,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Quest [ Yama ]",_G.Setting.AutoQuestYama,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Farm Mastery [ Fruit ]",_G.Setting.AutoFarmMasteryFruit,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Farm Mastery [ Gun ]",_G.Setting.AutoFarmMasteryGun,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Finish Dough Dungeons",_G.Setting.AutoFinishDoughDungeons,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Finish Phoenix Dungeons",_G.Setting.AutoFinishPhoenixDungeons,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Farm Material",_G.Setting.AutoFarmMaterial,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Godhuman",_G.Setting.AutoGodHuman,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Superhuman",_G.Setting.AutoSuperhuman,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Dragon Talon",_G.Setting.AutoDragonTalon,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Electric Claw",_G.Setting.AutoElectricClaw,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Shark Man",_G.Setting.AutoSharkmanKarate,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Death Step",_G.Setting.AutoDeathStep,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Farm Boss",_G.Setting.AutoFarmBoss,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Farm Boss [ Hop ]",_G.Setting.AutoFarmBossHop,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Farm Boss All",_G.Setting.AutoFarmBossAll,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Farm Observation",_G.Setting.AutoFarmObservation,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Farm Observation [ Hop ]",_G.Setting.AutoFarmObservationHop,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Buy Legendary Sword",_G.Setting.AutoBuyLegendarySword,function(value)
        SaveSetting()
        _G.AutoBuyLegendarySword = value
    end)

    Main:AddToggle("Auto Buy Legendary Sword [ Hop ]",_G.Setting.AutoBuyLegendarySwordHop,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Buy Enchament Haki",_G.Setting.AutoBuyEnchamentHaki,function(value)
        SaveSetting()
        _G.AutoBuyEnchamentHaki = value
    end)

    Main:AddToggle("Auto Buy Enchament Haki [ Hop ]",_G.Setting.AutoBuyEnchamentHakiHop,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Mystic Island",_G.Setting.AutoMysticIsland,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Hop Find Mystic Island [ Server ]",_G.Setting.HopFindIsland,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Elite Hunter",_G.Setting.AutoEliteHunter,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Elite Hunter [ Hop ]",_G.Setting.AutoEliteHunterHop,function(value)
        SaveSetting()
        _G.AutoEliteHunterHop = value
    end)
    Main:AddToggle("Stop At God's Chalice",_G.Setting.StopAtGodChalice,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Spawn Boss [ Cake Piece ]",_G.Setting.AutoSpawnBossCakePiece,function(value)
        SaveSetting()
        _G.AutoSpawnBossCakePiece = value
    end)

    Main:AddToggle("Auto Cake Piece",_G.Setting.AutoCakePiece,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Spin Bone",_G.Setting.AutoSpinBone,function(value)
        SaveSetting()
        _G.AutoSpinBone = value
    end)
    Main:AddToggle("Auto Farm Bone",_G.Setting.AutoFarmBone,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Buy Item Ectoplasm",_G.Setting.AutoBuyItem,function(value)
        SaveSetting()
        _G.EctoplasmBuy = value
    end)
    Main:AddToggle("Auto Farm Ectoplasm",_G.Setting.AutoFarmEctoplasm,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Evo Race v2",_G.Setting.Auto_EvoRace,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Aura Monster",_G.Setting.AuraMonster,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Musketeer Hat",_G.Setting.AutoMusketeerHat,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Observation Haki v2",_G.Setting.AutoObservationv2,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Rainbow Haki",_G.Setting.AutoRainbowHaki,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Get Yama",_G.Setting.AutoYama,function(value)
        SaveSetting()
        _G.AutoYama = value
        Clip = value
        if not value then
    ...
    Main:AddToggle("Auto Get Rengoku",_G.Setting.AutoRengoku,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Get Holy Torch",_G.Setting.GetTorch,function(value)
        SaveSetting()
        _G.GetTorch = value
        Clip = value
        if not value then
    ...
    Main:AddToggle("Auto Farm Bartilo [ Quest ]",_G.Setting.BartiloQuest,function(value)
        SaveSetting()
    ...
    Main:AddToggle("Auto Farm Players [ Quest ]",_G.Setting.PlayersQuest,function(value)
        SaveSetting()
    ...
    if _G.Setting.Points == nil then _G.Setting.Points = 3 end
    Stats:AddSlider("Point",1,100,_G.Setting.Points,function(value)
        SaveSetting()
        _G.Points = value
    end)

    Stats:AddToggle("Auto Up Status",_G.Setting.AutoUpStats,function(value)
        SaveSetting()
...
function UpdateFlowerEsp() 
    ...
    Dungeon:MyAddToggle({Name="Auto Buy Chips",Value=_G.Setting.BuyChip,Callback=function(value)
        _G.BuyChip = value
    end})
    Dungeon:MyAddToggle({Name="Auto Start Dungeons",Value=_G.Setting.StartDungeons,Callback=function(value)
    ...
    Dungeon:MyAddToggle({Name="Auto Next Island",Value=_G.Setting.NextIsland,Callback=function(value)
        _G.NextIsland = value
        Clip = value
    end})
    ...
    Dungeon:MyAddToggle({Name="Auto Awakener",Value=_G.Setting.Awakener,Callback=function(value)
        _G.Awakener = value
    end})
    ...
    Dungeon:MyAddToggle({Name="Aura Monster",Value=_G.Setting.KillAura,Callback=function(value)
        _G.KillAura = value
        Clip = value
    end})
    ...
    Misc:AddToggle("Skill Z",_G.Setting.Skill_Z,function(value)
        SaveSetting()
        _G.Skill_Z = value
    end)
    Misc:AddToggle("Skill X",_G.Setting.Skill_X,function(value)
        SaveSetting()
        _G.Skill_X = value
    end)
    Misc:AddToggle("Skill C",_G.Setting.Skill_C,function(value)
        SaveSetting()
        _G.Skill_C = value
    end)
    Misc:AddToggle("Skill V",_G.Setting.Skill_V,function(value)
        SaveSetting()
        _G.Skill_V = value
    end)
...
do
    AllString = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"
    function cryptshift(String,NumCrypt)
        local AllStringMake = String:split("")
        local MakeStringNumOne = ""
        for i,v in pairs(AllStringMake) do
            if v:upper() == v and v ~= " " and AllString:find(v) then
                OneString = AllString:find(v)
                OneString = OneString + NumCrypt 
                if OneString > 26 then
                    OneString = OneString - 26
                end
                local AllStringMakeHave = AllString:split("")
                MakeStringNumOne = MakeStringNumOne..AllStringMakeHave[OneString]:upper()
            elseif v:upper() ~= v and v ~= " " and AllString:find(v) then
                OneString = AllString:find(v)
                OneString = OneString + NumCrypt 
                if OneString > 26 then
                    OneString = OneString - 26
                ...
                MakeStringNumOne = MakeStringNumOne..v
            end
        end
        return MakeStringNumOne
    end
    StringMorseCode = ".- -... -.-. -.. . ..-. --. .... .. .--- -.- .-.. -- -. --- .--. --.- .-. ... - ..- ...- .-- -..- -.-- --.."
    StringMorseCode = StringMorseCode:split("")
    AllStringNewMorseCode = ""
    for i,v in pairs(StringMorseCode) do
        if v == "." then
            AllStringNewMorseCode = AllStringNewMorseCode.."1"
        elseif v == "-" then
            AllStringNewMorseCode = AllStringNewMorseCode.."2"
        else
            AllStringNewMorseCode = AllStringNewMorseCode.."3"
        end
        
    end
    AllStringNewMorseCode = AllStringNewMorseCode:split("3")
    local AllMakeByStringByMorseCode = {}
    for i,v in pairs(AllStringNewMorseCode) do
        table.insert(AllMakeByStringByMorseCode,v)
    end
    AllStringMorseCode = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"
    function ChangeThisToMorseCode(String)
        local String = String:upper():split("")
        local NewRetureSkill = ""
        for i,v in pairs(String) do
            if AllStringMorseCode:find(v) then
                NewRetureSkill = NewRetureSkill.."3"..AllMakeByStringByMorseCode[AllStringMorseCode:find(v)]
            else
                if tonumber(v) then
                    NewRetureSkill = NewRetureSkill..v
                else
                    NewRetureSkill = NewRetureSkill.."3"..v
                end
            end
        end
        return NewRetureSkill
    end
    ...
    crypt = crypt()
    function AllEAC(String)
        return cryptshift(crypt.sha512(base64enc(ChangeThisToMorseCode(cryptshift(String.."AvwefkamsciasdmdvfbdsdfefasdGNFRAWT"..String.."CreateByNealonX"..String.."AndAiavmwIapf"..String,13)))),13)
    end
    ...
    local function generateRandomString(length)
        local result = ""
        for _ = 1, length do
            local randomIndex = randomE:NextInteger(1, #characters)
    ...
    function Rotor.new(wiring, offset)
        local self = setmetatable({}, Rotor)
        self.wiring = wiring
        self.offset = offset
        return self
    end

    function Rotor:forward(letter)
        local index = (string.byte(letter) - 65 + self.offset) % 26
        return string.char((string.byte(self.wiring, index + 1) - 65 + 26) % 26 + 65)
    end

    function Rotor:backward(letter)
        local index = (string.find(self.wiring, letter, 1, true) - 53 - self.offset + 26) % 26
        return string.char(index + 65)
    end

    function Rotor:rotate()
    ...
    function Reflector.new(wiring)
        local self = setmetatable({}, Reflector)
        self.wiring = wiring
        return self
    end

    function Reflector:reflect(letter)
        local index = string.byte(letter) - 65
        return string.char(string.byte(self.wiring, index + 1))
    end
    ...
    function EnigmaMachine.new(rotorSettings, reflectorWiring)
        local self = setmetatable({}, EnigmaMachine)
        self.rotors = {}
        for _, rotorSetting in ipairs(rotorSettings) do
            local wiring, offset = rotorSetting.wiring, rotorSetting.offset
            table.insert(self.rotors, Rotor.new(wiring, offset))
        end
        self.reflector = Reflector.new(reflectorWiring)
        return self
    end

    function EnigmaMachine:encrypt(message)
        local encryptedMessage = ""
        for i = 1, #message do
            local letter = string.sub(message, i, i):upper()
            if letter:match("[A-Z]") then
                letter = self:processLetter(letter)
    ...
    function EnigmaMachine:processLetter(letter)
        self:rotateRotors()
        letter = self:runThroughRotors(letter)
        letter = self:reflect(letter)
        letter = self:runThroughRotors(letter, true)
        return letter
    end

    function EnigmaMachine:rotateRotors()
        for _, rotor in ipairs(self.rotors) do
            rotor:rotate()
        end
    end

    function EnigmaMachine:runThroughRotors(letter, backward)
        if ((self.rotors == self:reverseTable(self.rotors)) or (self.rotors == self:reverseTable(self:reverseTable(self.rotors)))) then
            while true do end
        end
        local result = letter
        local rotors = backward and self:reverseTable(self.rotors) or self.rotors
        for _, rotor in ipairs(rotors) do
            result = backward and rotor:backward(result) or rotor:forward(result)
        end
        return result
    end

    function EnigmaMachine:reflect(letter)
        return self.reflector:reflect(letter)
    end

    function EnigmaMachine:reverseTable(tbl)
        local reversedTable = {}
        local length = #tbl
        for i = length, 1, -1 do
    ...
    local rotorWirings = {
        ...
        "HPTXGWVBQDIUNLMECYKROZSAFJ",
        "PEZUOHXSCVFMTBGLRINQJWAYDK"
    }

    -- Reflector wirings
    local reflectorB = "YRUHQSLDPXNGOKMIEBFZCWVJAT"
    local reflectorC = "FVPJIAOYEDRZXWGCTKUQSBNMHL"
    local randomNEX = Random.new()

    allnumber = {}
    while true do
        random = randomNEX:NextInteger(1, 10)
        if random > 10 then
            while true do end
        end
        for i = 1,randomNEX:NextInteger(1, 10) do
            randomNEX:NextInteger(1, 10)
        end
        if not table.find(allnumber,random) then
            table.insert(allnumber,random)
        end
        if #allnumber == 10 then
            break
        end
        if #allnumber > 12 then
            while true do end
        end
    end
    ...
    -- Rotor settings
    local rotorSettings = {
        { wiring = rotorWirings[allnumber[1]], offset = 0 },
        { wiring = rotorWirings[allnumber[2]], offset = 0 },
        { wiring = rotorWirings[allnumber[3]], offset = 0 },
        { wiring = rotorWirings[allnumber[4]], offset = 0 },
        { wiring = rotorWirings[allnumber[5]], offset = 0 },
        { wiring = rotorWirings[allnumber[6]], offset = 0 },
        { wiring = rotorWirings[allnumber[7]], offset = 0 },
        { wiring = rotorWirings[allnumber[8]], offset = 0 },
        { wiring = rotorWirings[allnumber[9]], offset = 0 },
        { wiring = rotorWirings[allnumber[10]], offset = 0 }
    }

    -- Create Enigma machine
    local enigma = EnigmaMachine.new(rotorSettings, reflectorB)

    -- Example usage

    StringNew = generateRandomString(35)

    local plaintext = StringNew
    local ciphertext = enigma:encrypt(plaintext)
    local req = (syn and syn.request) or (http and http.request) or request;
    local Hwid = req({
        Url = "http://45.141.26.211:1234/hwid",
        Method = "GET"
    })
	if Hwid.Body == nil then
        Hwidez = game:GetService("RbxAnalyticsService"):GetClientId()
    else
        Hwidez = Hwid.Body
    end
	if gethwid ~= nil then
		if Hwid.Body ~= gethwid() and not delta then
			while true do end
		end
	end
    local Body = {
        ["str"] = StringNew,
        ["key"] = (getgenv()).Key,
        ["id"] = (getgenv()).DiscordID,
        ["hwid"] = Hwidez
    }
    OSTimEGetValueEieiSocute = tostring(os.time())
    local datanewzaza = game:GetService("HttpService"):JSONEncode(Body)
    data = ""
    for i,v in pairs(allnumber) do
        data = tostring(data)..tostring((v * 15 * 4 * 6 * 1 *5 *6 *7)).."19819"
    end
    function randomff(length)
        local res = ""
        for i = 1, length do
            res = res .. string.char(math.random(97, 122)) .. math.floor(os.time() + tick())
        end
        return res .. math.random(100, 999)
    end
    local DataUse = req({
        Url = "http://45.141.26.211:1234/"..AllEAC(randomff(23)).."/"..tostring(data),
        Method = "POST",
    ...
    if DataUse.Body ~= ciphertext then
        return game.Players.LocalPlayer:Kick(DataUse.Body)
    else
        print("Script.")
        YEDHODHEEYAYYAYASDO_ASDFMNCASDJI_ZXJI()
    end
end
